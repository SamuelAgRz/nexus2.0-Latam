...
| **C — Oversized** | 50+ rows received | Too-large message + 2 narrowing follow-ups. No narrative, no data block re-render. |
...
Use when the result contains **50 or more rows received**.
